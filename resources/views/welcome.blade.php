            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                                                             class="underline text-gray-900 light:text-white">Documentation</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 light:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                                                             class="underline text-gray-900 light:text-white">Laracasts</a>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 light:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                                                                             class="underline text-gray-900 light:text-white">Laravel
                                News</a></div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 light:border-gray-700 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 light:text-white">Vibrant
                            Ecosystem
                        </div>
                    </div>
