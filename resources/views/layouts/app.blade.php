            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-jet-nav-link
                            href="{{ LaravelLocalization::getLocalizedURL(getOtherLang(), null, [], true) }}">
                            {{ LaravelLocalization::getSupportedLocales()[getOtherLang()]['native'] }}
                        </x-jet-nav-link>
                    </div>
                </div>
                    ...
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                                ...
                                <!-- Team Settings -->
                                <x-jet-dropdown-link
                                    href="{{route('teams.show', ['team' => Auth::user()->currentTeam->id])}}">
